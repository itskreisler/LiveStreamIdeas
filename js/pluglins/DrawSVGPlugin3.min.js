...
!function(e, t) {
    ...
    function B(e) {
        ...
        "path" === l)
            ...
            for (o = e.getAttribute("points").match(P) || [],
            "polygon" === l && o.push(o[0], o[1]),
            r = 0,
            d = 2; d < o.length; d += 2)
                r += s(o[d - 2], o[d - 1], o[d], o[d + 1], x, g) || 0;
        else
            "circle" !== l && "ellipse" !== l || (f = y / 2 * x,
            h = m / 2 * g,
    ...
    var r, v, d, f, h, b, P = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi, O = {
        ...
        render: function render(e, t) {
            ...
            if (s) {
                for (t._live && (n = B(t._target)) !== t._length && (r = n / t._length,
                t._length = n,
